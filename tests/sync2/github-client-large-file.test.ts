...
// (getLatestCommitDateForPath died at THE SWITCH — its only consumer
// was the old engine's plugin-js mtime tiebreak; the new drain gets
// commit dates from getCommitInfoForPath/listCommitsForPath.)
