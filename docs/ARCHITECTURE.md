...
└── sync2/
    ...
    ├── dot-space.ts                 # The opt-in set: `!`-rule classification (§4.2),
    │                                #  readRootGitignore, walkDotDir. Shared by the change
