...
| 4 | **retention + щит**: `pruneBefore` наприкінці успішного drain-у, `hold/unhold` у пам'яті | ↓ цей коміт |
>
> **Лишилось:**
> - 🟢 **прибирання старого кошика РОЗБЛОКОВАНО** (retention вирішено, див. нижче) —
>   `TrashStore`/`trash-recovery`/`.trash/` більше ніхто не пише і не читає; лишилось
>   видалити.
> - ⏳ **ексклюзивність «одна сесія на запис»** — єдине, що ще чекає рішення.
