...
27. Налаштувати розмір і текст кнопок в diff-panel/diff-history/diff-deleted/diff-editor для нормального показу на 
...
28. зловився diff-conflict в plugin-каталозі. Це — дупа. Там не повинен ловитись конфлікт. хіба що в data.json. Решта 
    файлів мають змінюватись атомарно 

29. на мобілці не працює копіювання diff-groups. Вставляється текст замість групи: ![diff-group не вставляється з кліпбоард як diff-group](imgs/screenshot-mobile-10.jpeg) 
