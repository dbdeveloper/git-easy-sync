...
зрозумівши, що роз-шарив керуючий файл. Ліки — помітність, а не хардкод: лог/нотиця
«root `.gitignore` більше не синкається — цей пристрій тепер має власні dot-правила».
