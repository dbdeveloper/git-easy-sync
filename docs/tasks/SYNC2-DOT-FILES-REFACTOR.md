...
(METAFILE §6.3): відсутній `END` просто не входить у вимірюваний відрізок. ⚠️ Але
сьогоднішні константи маркери включають (`gitignore-invariants.ts:50-59`, `:93-105`) —
щоб це реалізувати, їх треба спершу **розділити** на маркери + тіло.
