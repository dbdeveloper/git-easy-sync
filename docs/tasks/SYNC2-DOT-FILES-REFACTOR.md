...
**🔴 Дефект 1 — перемикач ON фактично no-op.** Блок пише `!plugins/*/data.json` УГОРІ
...
**🟡 Дефект 2 — релікт воскрешає ON.** Після рейму маркер блоку інший
...
- **TD6a.7 [int]** S1 OFF: у блобах, які пуш ДОДАВ, немає БАЙТІВ токена; жодного шляху
