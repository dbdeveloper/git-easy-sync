...
>
> ⚠️ **ЗНАХІДКА при написанні J.1 — вікно краху STEP1 → епілог (нове, НЕ виправлено).**
...
> Два кандидати на фікс (рішення власника): durable-save конфлікту раніше (на STEP1/STEP3,
> а не в епілозі) АБО двогілковий пошук synthetic (§4.3.1 DOT-FILES, Крок C черги робіт),
> після якого orphan-sibling потрапляє в скан і правило RECONCILE не спрацьовує хибно.
> Природне місце для регресії — §VIII D (матриця краху, Фаза 6).
