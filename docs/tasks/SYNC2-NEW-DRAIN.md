...
на несучій підмножині. Прохід 3 (проби з інверсією) — **не робився**; кандидати названі
нижче.
...
### IX.3 Що НЕ перевірено і чим це закривати

- **Прохід 3 (проби з інверсією) не робився.** Урок 2026-09-20 чинний: ID сценарію в
  назві тесту не доводить покриття, і показала це саме інверсія пінованого рядка.
  Кандидати за спаданням підозри: правила **4.5.a/b** (null-як-база) і **4.6.b**
  (свідома асиметрія до 4.6.a) — обидва вузькі й легко зламати рефактором так, що
  вердикт лишиться правдоподібним; **3.b.\*.e** (єдине місце, де порівнюються mtime);
  категорії §VIII, закриті гуртом 2026-09-20 (A.1/C/F/H/I/L), яких відтоді ніхто не
  чіпав.
